...
export const MissionStatement = () => {
    return (
        <section className="flex items-center justify-center py-10 sm:py-12 md:py-16 lg:py-[100px] px-4 sm:px-6 md:px-[120px] w-full">
            <div className="flex flex-col lg:flex-row items-start max-w-[1200px] w-full gap-6 sm:gap-8 lg:gap-16">
                <div className="flex flex-col min-w-0 lg:min-w-[536px] lg:max-w-[536px] gap-7 sm:gap-8 md:gap-[45.75px] w-full">
                    <div className="flex flex-col gap-4 sm:gap-5 md:gap-[22px]">
                        ...
                        <div className="flex flex-col gap-3 sm:gap-4 md:gap-[18px]">
                            <div className="-translate-y-4 animate-fade-in opacity-0 [--animation-delay:200ms]">
                                <h2 className="text-start font-semibold text-[22px] sm:text-[28px] md:text-[34px] lg:text-[38px] tracking-[-1.14px] leading-[1.3] md:leading-[49.4px]">
                            ...
                            <div className="-translate-y-4 animate-fade-in opacity-0 [--animation-delay:400ms]">
                                <p className="text-start font-normal text-brentor-templateframerwebsiteshuttle-gray text-xs sm:text-sm md:text-base tracking-[-0.48px] leading-[20px] sm:leading-[22px] md:leading-[25.6px]">
