...
export const HeroContentSection = (): JSX.Element => {
  return (
    <header className="w-full fixed top-0 left-0 z-50 -translate-y-4 animate-fade-in opacity-0">
      <nav className="bg-[#1180c5] w-full">
        <div className="max-w-[1200px] mx-auto px-[15px] min-h-20 flex items-center justify-between">
          <img
            className="h-auto -translate-y-2 animate-fade-in opacity-0 [--animation-delay:200ms]"
            alt="Company Logo"
            src="https://c.animaapp.com/mlxaygwhYd0iJj/img/frame-3-1.svg"
          />

          <ul className="flex items-center gap-0 -translate-y-2 animate-fade-in opacity-0 [--animation-delay:400ms]">
