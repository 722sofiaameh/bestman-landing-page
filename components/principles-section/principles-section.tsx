    ...
    <section className="relative w-full mb-20 bg-[#1180C5] py-[120px] px-4 md:px-8 lg:px-[120px] overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto">
        ...
        <div className="text-center mb-12">
          <p className="text-white/80 text-sm font-semibold tracking-[0.12em] uppercase mb-4">
            How we work
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr] gap-4 items-stretch">
          ...
          <div className="flex flex-col gap-4">
            {/* Card 1 */}
            <div className="flex-1 bg-[#0e7aaf] rounded-sm p-8">
          ...
          {/* Center image */}
          <div className="w-full lg:w-[360px] xl:w-[420px] rounded-sm overflow-hidden">
            <img
              src="https://picsum.photos/seed/construction-worker/420/500"
