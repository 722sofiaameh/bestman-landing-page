    ...
    <section className=" flex items-center justify-center mt-12 pt-[129px] pb-12 px-4 md:px-[120px] bg-[#1180c5] overflow-visible">
      <div className="flex items-center justify-center px-[15px] py-0 max-w-[1200px] w-full relative">
        <div className="flex flex-col items-start gap-[18.9px] w-full max-w-[1170px]">
          ...
          <div className="flex flex-col items-start w-[685px] -translate-y-4 animate-fade-in opacity-0 [--animation-delay:200ms]">
          ...
          <div className="flex flex-col items-start max-w-[590px] w-full -translate-y-4 animate-fade-in opacity-0 [--animation-delay:400ms]">
        ...
        <aside className="absolute top-0  right-[15px] w-[350px] bg-[#0c6e8a] pt-[29px] pb-[30px] px-[30px] -translate-y-4 animate-fade-in opacity-0 [--animation-delay:600ms]">
          <div className="flex flex-col gap-[118.2px]">
            ...
            <div className="flex flex-col gap-2.5 -translate-y-4 animate-fade-in opacity-0 [--animation-delay:600ms]">
